/* Typert host descriptor for the scriptLibrary namespace — hand-written in
 * the shape the generator emits (reference: @deepseek-ai/dsh-host-plugin-inventory
 * lib/typert.host.js). Plain ESM JS — no build step. */
import { z } from "zod";
...
const stringCodec = {
  mode: "strict",
  typeSymbol: "dsh-script-library/types#String",
  schema: z.string(),
};
